...
<meta property="og:description" content="١٤ تطبيقًا عربيًا: بلا إعلانات، بلا تتبّع، بلا سحابة. الكثير منها لا يملك إذن الإنترنت أصلًا.">
...
<header id="top">
  ...
  <div class="hero-in">
    ...
    <p class="sub">أربعة عشر تطبيقًا وُلدت في بيتٍ واحد: <b>بلا إعلانات، بلا تتبّع، بلا سحابة</b>. بياناتك تبقى على جهازك وحده — والكثير منها لا يملك إذن الإنترنت أصلًا، فلا يستطيع إفشاء سرّك حتى لو أراد.</p>
    <div class="ctas">
...
<section id="principles">
  <div class="wrap">
    ...
    <h2>الخصوصية عندنا عقيدة، لا إعداد</h2>
    ...
    <div class="prin">
      <div class="p-card reveal"><div class="ic"><svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M1 1l22 22M9 9a7 7 0 0 1 10 6M5 12a11 11 0 0 1 2.6-3.4M12 20h.01M8.5 16.5a5 5 0 0 1 5.5-1"/></svg></div>
        <h3>بلا إنترنت حيث يجب</h3><p>الوثائق والتقويم والإشعارات والسِتر: حزمها لا تحمل إذن الإنترنت أصلًا — العجز عن الإفشاء خيرٌ من الوعد بعدمه.</p></div>
...
<section id="apps" style="padding-top:20px">
  <div class="wrap">
    ...
    <p class="lead">كل تطبيقٍ يسدّ حاجةً يومية حقيقية — ويشارك إخوته العقيدة نفسها: بياناتك ملكك وحدك.</p>
